# -*- coding: utf-8 -*-
# Generated by Django 1.11.18 on 2019-01-22 21:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='users.Manufacturer', verbose_name='suoshuzhizaoshang')),
            ],
            options={
                'ordering': ['id'],
